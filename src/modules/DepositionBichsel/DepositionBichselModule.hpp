...
#define N2 64
    ...
    public:
         ...
         */
        Cluster(int eh_pairs, ROOT::Math::XYZPoint pos, double energy, size_t particle_id, double time)
            : neh(eh_pairs), position(pos), E(energy), particle_id_(particle_id), time_(time){};
        int neh;
