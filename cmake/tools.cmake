...
FUNCTION(add_tool_test)
    ...
    SET_TESTS_PROPERTIES(tools/${ADD_TOOL_TEST_NAME} PROPERTIES REQUIRED_FILES "${ADD_TOOL_TEST_DATA}")
    ...
    SET_TESTS_PROPERTIES(tools/check_${ADD_TOOL_TEST_NAME} PROPERTIES DEPENDS "tools/${ADD_TOOL_TEST_NAME}")
