...
void DetectorHistogrammerModule::initialize() {
    ...
    std::string hit_map_local_title = "Hitmap for " + detector_->getName() + " (local coord.);x (mm);y (mm);hits";
    ...
    std::string efficiency_local_title =
        "Efficiency of " + detector_->getName() + " (MCParticle positions, local coord.);x (mm);y (mm);efficiency";
